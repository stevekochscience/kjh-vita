...
\ind 2003. Ph.D, Physics (Biophysics Minor). % Dissertation: \emph{Exchange in Blood and
%   Organs}. %\vspace{-0.1in}  
...
\ind 200. M.S., Physics (Biophysics Minor). 


\medskip
\noindent\emph{University of Michigan, Ann Arbor\vspace{0.02in}}

\ind 1996. B.S., Phsyics (Honors). \vspace{0.01in}
